...
import { CreateAccountFieldWrapper, RoleContainer } from "../CreateAccount/CreateAccountStyles";
...
function MakeRequest() {
    ...
    const donationTypeRef : any = useRef("")
    ...
    const handleRequest = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (imageUrl === "" && imageUpload !== null) {
            ...
            try {
                setShowLoading(true)
                setTimeout(async () => {
                    console.log(donationTypeRef.current.value)
                    const request = {
                        campaignId: v4(),
                        ...
                        donationType: donationTypeRef.current.value
            ...
            <DonationForms style={{ height: '500px', gap: '30px' , margin: '5px'}} onSubmit={handleRequest} >
                ...
                <div style={{width: "100%"}}>
                    ...
                    <CreateAccountFieldWrapper>
                            <InputLabel htmlFor='options'>Donation Type</InputLabel>
                            <RoleContainer id="options" ref={donationTypeRef}>
